...
// //     const orderDetails = await cartModel.find({
...
// //         }]
// //     }
// //     paypal.payment.create(await create_payment_json, async function (error, payment) {
// //       if (error) {
// //         console.log(error);
// //       } else {
...
// //             console.log(".............this is the paypallink for payment........",links[i])
...
//   console.log("this is the req.session.userInfo details .....=",req.session.userInfo);
//   try {
...
//     let orderData = await cartModels.find({userId:req.session.userInfo._id}).populate("productId");

//     let wholeProducts = [];
//     for(let i=0;i<orderData.length;i++){
//       wholeProducts.push({
//         "name":orderData[i].productId.productName,
//         "price":orderData[i].productId.price,
//         "currency":"USD",
//         "quantity":orderData[i].productId.quantity,
//       })
//     }
